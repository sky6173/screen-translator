...
这是第一个按正式安装包流程发布的 Windows 版本。用户已完成本地安装、启动、基础功能和卸载测试。
...
- SHA256：`1970627b3c9df7d73797fb4da750088774180b74a7ddd552ed7219b6e7b10388`
...
- SHA256：`a3a0aed78eb720c008e5d87c9ec71f46f55b01b0e2936a9d31621f36ce0ab37e`

## 本版重点

- 使用新的中文安装向导，支持选择安装目录。
- 卸载时会清理安装器创建的程序文件夹和快捷方式。
- 继续保留便携版压缩包，方便不安装时临时运行。
- API Key 仍保存在本机，并使用 Windows 当前用户 DPAPI 保护。
